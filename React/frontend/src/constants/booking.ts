...
/**
 * Days ahead a booking can be made (today + this many). Display only: the
 * server enforces its own ADVANCE_BOOKING_DAYS (backend config/booking.js) and
 * refuses a later date whatever the page sends.
 */
export const ADVANCE_BOOKING_DAYS = 2;
